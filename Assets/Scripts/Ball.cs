...
public class Ball : MonoBehaviour
{
    ...
    GameState gameState;
    [SerializeField] public bool isThisBallPickedUp = false; //we will leave this varible to identfy the state of this specifc ball
    ...
    public void GetPickedByPlayer()
    {
        ...
        ballSticky.StopDisableStikcingAfterTimeCoroutine();
    ...
    public bool IsThisBallPickedUp()
    {
        return isThisBallPickedUp;
    }
}
